...
function useCurrentColorScheme(options) {
  ...
  const setMode = React6.useCallback((mode) => {
  ...
  const setColorScheme = React6.useCallback((value) => {
    if (!value) {
      setState((currentState) => {
        try {
  ...
  const handleMediaQuery = React6.useCallback((event) => {
  ...
  const mediaListener = React6.useRef(handleMediaQuery);
...
function createCssVarsProvider(options) {
  ...
  const ColorSchemeContext = React7.createContext(void 0);
  if (true) {
    ColorSchemeContext.displayName = "ColorSchemeContext";
  }
  const useColorScheme = () => {
    const value = React7.useContext(ColorSchemeContext);
    if (!value) {
  ...
  function CssVarsProvider(props) {
    ...
    const element = (0, import_jsx_runtime7.jsxs)(React7.Fragment, {
      children: [shouldGenerateStyleSheet && (0, import_jsx_runtime7.jsxs)(React7.Fragment, {
...
function createGrid(options = {}) {
  ...
  const GridOverflowContext = React9.createContext(void 0);
  if (true) {
  ...
  const Grid2 = React9.forwardRef(function Grid3(inProps, ref) {
    var _inProps$columns, _inProps$spacing, _ref, _inProps$rowSpacing, _ref2, _inProps$columnSpacin, _ref3, _disableEqualOverflow;
    const theme = useTheme_default();
    const themeProps = useThemeProps2(inProps);
    const props = extendSxProp(themeProps);
    const overflow2 = React9.useContext(GridOverflowContext);
    const {
      className,
      children,
    ...
    let result = (0, import_jsx_runtime9.jsx)(GridRoot, _extends({
      ...
      children: React9.Children.map(children, (child) => {
        if (React9.isValidElement(child) && isMuiElement(child, ["Grid"])) {
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-GQFZNCSX.js.map
