...
//		,	Total Engine Time,		Total Stop Time		
  ...
  const [columns, setColumns] = useState([
    ...
    { key: 'stopTime', label: 'Total Stop Time' },
    { key: 'startTime', label: 'Start Time' },
    { key: 'endTime', label: 'End Time' },
    { key: 'avgSpeed', label: 'Average Speed (Km/h)' },
    { key: 'distanceKm', label: 'Total Distance (KM)' },
    { key: 'firstIgnition', label: 'First Ignition' },
    { key: 'lastIgnition', label: 'Last Ignition' },
    { key: 'maxSpeed', label: 'Max Speed (Km/h)' },
    { key: 'maxSpeedTime', label: 'Max Speed Time' },
    { key: 'idleTime', label: 'Total Idle Time' },
    { key: 'engineTime', label: 'Total Engine Time' }
