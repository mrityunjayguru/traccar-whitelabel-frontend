...
const PreferencesPage = () => {
  ...
  return (
    ...
    >
      <Container maxWidth="md" className={`${classes.container} flex flex-col gap-4`}>
        {!readonly && (
          <>
            <Accordion defaultExpanded className="mb-4! border! border-gray-200! dark:border-[#333] rounded-md! before:hidden overflow-hidden! shadow-none!">
              <AccordionSummary expandIcon={<ExpandMoreIcon />} className="bg-gray-50/50 dark:bg-[#2a2a2e]/50 border-b! border-gray-200! dark:border-[#333]">
                <Typography variant="subtitle1" className="font-semibold">{t("mapTitle")}</Typography>
              </AccordionSummary>
              <AccordionDetails className={`${classes.details} pt-4`}>
                <FormControl>
            ...
            <Accordion className="mb-4! border! border-gray-200! dark:border-[#333] rounded-md! before:hidden overflow-hidden! shadow-none!">
              <AccordionSummary expandIcon={<ExpandMoreIcon />} className="bg-gray-50/50 dark:bg-[#2a2a2e]/50 border-b! border-gray-200! dark:border-[#333]">
                <Typography variant="subtitle1" className="font-semibold">{t("deviceTitle")}</Typography>
              </AccordionSummary>
              <AccordionDetails className={`${classes.details} pt-4`}>
                <SelectField
            ...
            <Accordion className="mb-4! border! border-gray-200! dark:border-[#333] rounded-md! before:hidden overflow-hidden! shadow-none!">
              <AccordionSummary expandIcon={<ExpandMoreIcon />} className="bg-gray-50/50 dark:bg-[#2a2a2e]/50 border-b! border-gray-200! dark:border-[#333]">
                <Typography variant="subtitle1" className="font-semibold">{t("sharedSound")}</Typography>
              </AccordionSummary>
              <AccordionDetails className={`${classes.details} pt-4`}>
                <SelectField
                  multiple
        ...
        <Accordion className="mb-4! border! border-gray-200! dark:border-[#333] rounded-md! before:hidden overflow-hidden! shadow-none!">
          <AccordionSummary expandIcon={<ExpandMoreIcon />} className="bg-gray-50/50 dark:bg-[#2a2a2e]/50 border-b! border-gray-200! dark:border-[#333]">
            <Typography variant="subtitle1" className="font-semibold">{t("userToken")}</Typography>
          </AccordionSummary>
          <AccordionDetails className={`${classes.details} pt-4`}>
            <TextField
